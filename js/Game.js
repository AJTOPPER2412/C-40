class Game {
  ...
  handleObstacles(index){
    ...
    showLife() {
      push();
      image(lifeImage, width / 2 - 130, player.positionY - 100, 20, 20);
      fill("white");
